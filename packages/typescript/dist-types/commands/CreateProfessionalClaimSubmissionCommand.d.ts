...
import type { CreateProfessionalClaimSubmissionInput, CreateProfessionalClaimSubmissionOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateProfessionalClaimSubmissionCommand_base: {
    new (input: CreateProfessionalClaimSubmissionCommandInput): import("@smithy/core/client").CommandImpl<CreateProfessionalClaimSubmissionCommandInput, CreateProfessionalClaimSubmissionCommandOutput, import("..").StediClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateProfessionalClaimSubmissionCommandInput): import("@smithy/core/client").CommandImpl<CreateProfessionalClaimSubmissionCommandInput, CreateProfessionalClaimSubmissionCommandOutput, import("..").StediClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @internal
 */
export declare class CreateProfessionalClaimSubmissionCommand extends CreateProfessionalClaimSubmissionCommand_base {
