...
import {
  ...
  defaultStediHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type StediClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
 ...
 * @public
 */
export type StediClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
