...
class HTTPAuthSchemeResolver:
    def resolve_auth_scheme(self, auth_parameters: AuthParams[Any, Any]) -> list[_smithy_core_interfaces_auth_AuthOption]:
...
def _generate_api_key_option(auth_params: AuthParams[Any, Any]) -> _smithy_core_interfaces_auth_AuthOption | None:
    return _smithy_core_auth_AuthOption(
        scheme_id=ShapeID("smithy.api#httpApiKeyAuth"),
