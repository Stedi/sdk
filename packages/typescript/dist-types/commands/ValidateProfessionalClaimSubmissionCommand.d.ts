...
import type { ValidateProfessionalClaimSubmissionInput, ValidateProfessionalClaimSubmissionOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ValidateProfessionalClaimSubmissionCommand_base: {
    new (input: ValidateProfessionalClaimSubmissionCommandInput): import("@smithy/core/client").CommandImpl<ValidateProfessionalClaimSubmissionCommandInput, ValidateProfessionalClaimSubmissionCommandOutput, import("..").StediClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ValidateProfessionalClaimSubmissionCommandInput): import("@smithy/core/client").CommandImpl<ValidateProfessionalClaimSubmissionCommandInput, ValidateProfessionalClaimSubmissionCommandOutput, import("..").StediClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
