import type { ClaimAcknowledgmentStatus, ClaimPaymentInformationStatusCode, ClaimStatus, ClaimStatusReportedBy, ClaimType, EligibilityCheckCoverageLevel, EligibilityCheckCoverageStatus, EligibilityCheckDependentRelationship, EligibilityCheckDiagnosisCodeSystem, EligibilityCheckEntityProviderCode, EligibilityCheckEntityRelationship, EligibilityCheckInsuranceType, EligibilityCheckInvalidEntryReasonCode, EligibilityCheckMaintenanceIndicator, EligibilityCheckNetworkIndicator, EligibilityCheckPayerEntityIdentifierCode, EligibilityCheckPlaceOfServiceCode, EligibilityCheckPriorAuthIndicator, EligibilityCheckProviderEntityIdentifierCode, EligibilityCheckQuantityQualifier, EligibilityCheckRelatedEntityIdentifierCode, EligibilityCheckRequestDependentRelationship, EligibilityCheckRequestEntityProviderCode, EligibilityCheckRequestPatientGender, EligibilityCheckRequestProviderType, EligibilityCheckRequestServiceCodeSystem, EligibilityCheckResponseErrorLocation, EligibilityCheckResponsePatientGender, EligibilityCheckResponseServiceCodeSystem, EligibilityCheckServiceDeliveryLimitFrequencyQualifier, EligibilityCheckServiceDeliveryLimitPattern, EligibilityCheckServiceDeliveryLimitPeriodQualifier, EligibilityCheckServiceDeliveryLimitQuantityQualifier, EligibilityCheckServiceDeliveryLimitSchedule, EligibilityCheckTimePeriod, EligibilityCheckTraceType, EventDestinationsDestinationInputStatus, EventDestinationsDestinationStatus, EventDestinationsEventEnvironment, EventDestinationsEventPayloadObjectType, EventDestinationsEventStatus, ProfessionalClaimSubmissionAttachmentReportTypeCode, ProfessionalClaimSubmissionAttachmentTransmissionCode, ProfessionalClaimSubmissionBenefitsAssignmentCertificationIndicator, ProfessionalClaimSubmissionClaimFilingIndicator, ProfessionalClaimSubmissionClaimFrequencyCode, ProfessionalClaimSubmissionDrugIdentificationUnitOfMeasure, ProfessionalClaimSubmissionEPSDTReferralConditionIndicator, ProfessionalClaimSubmissionGenderCode, ProfessionalClaimSubmissionInsuranceType, ProfessionalClaimSubmissionMedicareSecondaryInsuranceType, ProfessionalClaimSubmissionOtherInsuredRelationshipToInsured, ProfessionalClaimSubmissionPatientRelationshipToInsured, ProfessionalClaimSubmissionPaymentResponsibilityLevelCode, ProfessionalClaimSubmissionProviderAcceptsAssignment, ProfessionalClaimSubmissionProviderSignature, ProfessionalClaimSubmissionPurchasedServiceProviderEntityType, ProfessionalClaimSubmissionPurpose, ProfessionalClaimSubmissionReleaseOfInformationCode, ProfessionalClaimSubmissionResponsibilityLevel } from "./enums";
/**
 ...
 * @public
 */
export type EligibilityCheckRequestProviderName = EligibilityCheckRequestProviderName.OrganizationMember | EligibilityCheckRequestProviderName.PersonMember | EligibilityCheckRequestProviderName.$UnknownMember;
/**
 * @public
 */
export declare namespace EligibilityCheckRequestProviderName {
    /**
     * The name of a provider who is a person.
     * @public
     */
 ...
 * @public
 */
export type EligibilityCheckRequestSubscriberName = EligibilityCheckRequestSubscriberName.OrganizationMember | EligibilityCheckRequestSubscriberName.PersonMember | EligibilityCheckRequestSubscriberName.$UnknownMember;
/**
 * @public
 */
export declare namespace EligibilityCheckRequestSubscriberName {
    /**
     * The name of a subscriber who is a person.
     * @public
     */
 ...
 * @public
 */
export type EligibilityCheckPersonOrOrganizationName = EligibilityCheckPersonOrOrganizationName.OrganizationMember | EligibilityCheckPersonOrOrganizationName.PersonMember | EligibilityCheckPersonOrOrganizationName.$UnknownMember;
/**
 * @public
 */
export declare namespace EligibilityCheckPersonOrOrganizationName {
    /**
     * A person's name. Maps to elements NM103 through NM107.
     * @public
     */
 ...
 * @public
 */
export type EligibilityCheckServiceLimit = EligibilityCheckServiceLimit.AgeMaximumMember | EligibilityCheckServiceLimit.AgeMinimumMember | EligibilityCheckServiceLimit.DeliveryMember | EligibilityCheckServiceLimit.$UnknownMember;
/**
 * @public
 */
export declare namespace EligibilityCheckServiceLimit {
    /**
     * The maximum patient age (in years) for this benefit.
     * @public
     */
    interface AgeMaximumMember {
        ageMaximum: number;
        ageMinimum?: never;
        delivery?: never;
        $unknown?: never;
